  ...
  return (
    <Box sx={{ display: "flex", justifyContent: "center" }}>
      ...
      <Box sx={{ display: "flex", flexDirection: "column" }}>
        ...
        <IconButton sx={sx} variant="text" color="error" size="large" disabled>
          <ArrowForward></ArrowForward>
        </IconButton>
      </Box>
      ...
      <Box sx={{ display: "flex", flexDirection: "column" }}>
        ...
        <IconButton sx={sx} variant="light" color="error" size="large" disabled>
          <ArrowForward></ArrowForward>
        </IconButton>
      </Box>
    </Box>
  ...
  return (
    <Box sx={{ display: "flex", justifyContent: "center" }}>
      ...
      <Box sx={{ display: "flex", flexDirection: "column" }}>
        ...
        <IconButton sx={sx} variant="text" color="error" size="small" disabled>
          <ChevronRight></ChevronRight>
        </IconButton>
      </Box>
      ...
      <Box sx={{ display: "flex", flexDirection: "column" }}>
        ...
        <IconButton sx={sx} variant="light" color="error" size="small" disabled>
          <ChevronRight></ChevronRight>
        </IconButton>
      </Box>
